...
INSERT INTO "new_Settings" ("createdAt", "id", "orderConfirmationEnabled", "orderConfirmationMessage", "phoneNumberId", "updatedAt", "whatsappToken") SELECT "createdAt", "id", "orderConfirmationEnabled", "orderConfirmationMessage", "phoneNumberId", "updatedAt", "whatsappToken" FROM "Settings";
DROP TABLE "Settings";
