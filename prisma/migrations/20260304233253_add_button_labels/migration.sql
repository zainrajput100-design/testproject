...
INSERT INTO "new_Settings" ("abandonedCartDelay", "abandonedCartEnabled", "abandonedCartMessage", "cancellationEnabled", "cancellationMessage", "createdAt", "fulfillmentEnabled", "fulfillmentMessage", "id", "orderConfirmationEnabled", "orderConfirmationMessage", "phoneNumberId", "updatedAt", "whatsappToken") SELECT "abandonedCartDelay", "abandonedCartEnabled", "abandonedCartMessage", "cancellationEnabled", "cancellationMessage", "createdAt", "fulfillmentEnabled", "fulfillmentMessage", "id", "orderConfirmationEnabled", "orderConfirmationMessage", "phoneNumberId", "updatedAt", "whatsappToken" FROM "Settings";
DROP TABLE "Settings";
